...
# Force QtWebEngine to use software rendering or basic desktop OpenGL
os.environ["QTWEBENGINE_CHROMIUM_FLAGS"] = "--disable-gpu --disable-software-rasterizer"
# Alternative flag if the one above still fails:
# os.environ["QT_GL_MODULE"] = "software"
...
from PyQt6.QtWebEngineCore import QWebEngineProfile, QWebEngineDownloadRequest, QWebEngineProfile
from PyQt6.QtWidgets import (
    QApplication, QMainWindow, QVBoxLayout, QHBoxLayout, 
    QWidget, QLineEdit, QPushButton, QTabWidget, QProgressBar, 
    QStatusBar, QListWidget, QSplitter, QMenu, QFileDialog, 
    QToolButton, QTabBar, QLabel, QTextEdit, QComboBox
)
