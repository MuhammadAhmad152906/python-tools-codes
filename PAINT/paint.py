...
class UltimatePaint:
    def __init__(self, root):
        ...
        # Reduced Canvas Size (Compact Layout)
        ...
        style_frame = tk.Frame(root, pady=5)
        ...
        # FORCED VISIBILITY STYLE: Explicit colors to stop system themes from hiding it
        ...
        self.style_menu.config(
            ...
            relief="groove",   # Visually pops out
            borderwidth=2
        )
        self.style_menu.pack(side=tk.LEFT, padx=5)
        
        self.preview_canvas = tk.Canvas(style_frame, bg="white", width=200, height=35, highlightthickness=1, highlightbackground="gray")
    ...
    def update_preview(self):
        ...
        style=self.styles[self.style_var.get()]
        self.preview_canvas.create_line(10,18,190,18,width=self.pen_size,fill=self.pen_color,
    ...
    def draw_spiral(self):
        ...
        # Center adjusted to the 900x600 canvas sizing
